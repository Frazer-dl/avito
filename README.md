...
---
##Описание
Для решения данной задачи использовались бд redis, библиотека ehcache, spring-boot rest api.
Ключом для сохранения данных в redis является переменная HASH_KEY, для ehcache - "cache"
Поиск, удаление и сохранения значений происходит по перменной Long ID.
